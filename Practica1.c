...
//-----FUNCIONES
//EJERCICIO 15
// int max(int param1, int param2, int param3){
//     if (param1>param2){
//         return param1;
//     }
...
// int ladosTriangulo(int param1, int param2, int param3){
//     int maximo = max (param1,param2,param3);
//     if (maximo == param1){
...
//         printf("Ingrese el primer numero:\n");
//         printf("Ingrese el segundo numero:\n");
//         printf("Ingrese el tercer el numero:\n");
//         scanf("%d%d%d",&num1,&num2,&num3);

//         int lados =ladosTriangulo(num1,num2,num3);
//         return lados;
//     }

// //EJERCICIO 17
//  Definir una función esRectangulo que tome tres enteros y devuelva 1 si los
// números que se le pasan pueden ser los lados de un triángulo rectángulo, y 0 en caso con-
// trario. Sugerencia: una manera sería verificar si el cuadrado del mayor es igual la suma de los
// cuadrados de los otros dos. Sin embargo existe otra manera utilizando solo una vez una fun-
// ción max3, que devuelve el máximo entre tres enteros dados. Definir ambas funciones y probar
...
int main(){
    ...
    int verifica = esRectangulo(n1,n2,n3);
